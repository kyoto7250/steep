  ...
  class Names
    ...
    EOF
      ...
      const_env = ConstantEnv.new(
        ...
        resolver: RBS::ConstantResolver.new(builder: factory.definition_builder)
      )
...
class Steep end
    EOS
      ...
      annotations = source.annotations(block: source.node, factory: checker.factory, current_module: Namespace.root)
      const_env = ConstantEnv.new(factory: factory, context: [Namespace.root], resolver: RBS::ConstantResolver.new(builder: factory.definition_builder))
      type_env = TypeEnv.build(annotations: annotations,
                               subtyping: checker,
                               const_env: const_env,
                               signatures: checker.factory.env)
