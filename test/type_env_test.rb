...
class TypeEnvTest < Minitest::Test
  ...
  def test_ivar_without_annotation
    with_checker do |checker|
      const_env = ConstantEnv.new(factory: checker.factory, context: [], resolver: RBS::ConstantResolver.new(builder: checker.factory.definition_builder))
  ...
  def test_const_without_annotation
    with_checker do |checker|
      const_env = ConstantEnv.new(factory: checker.factory, context: [RBS::Namespace.root], resolver: RBS::ConstantResolver.new(builder: checker.factory.definition_builder))
      type_env = TypeEnv.new(subtyping: checker, const_env: const_env)
